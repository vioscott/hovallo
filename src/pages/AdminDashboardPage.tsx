...
import { CheckCircleIcon, XCircleIcon, TrashIcon, UserIcon, HomeIcon } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="text-gray-500">Manage listings and users</p>
        </div>
        ...
        <div className="flex space-x-4 mb-6 border-b border-gray-200">
          <button
            ...
            className={`pb-4 px-2 font-medium text-sm transition-colors relative ${activeTab === 'listings'
          ...
          <button
            ...
            className={`pb-4 px-2 font-medium text-sm transition-colors relative ${activeTab === 'users'
              ? 'text-blue-600 border-b-2 border-blue-600'
              : 'text-gray-500 hover:text-gray-700'
              }`}
          >
